...
use constellation_channels::near::types::CompoundNearChannelsDatagramSelectorPollTypes;
...
type ExampleServerPollTypes = CompoundNearChannelsDatagramSelectorPollTypes<
    Vec<u8>,
    Vec<u8>,
    Vec<u8>,
    TestBytesCodec,
...
type ExampleClientPollTypes = CompoundNearChannelsDatagramSelectorPollTypes<
    Vec<u8>,
    Vec<u8>,
    Vec<u8>,
    TestBytesCodec,
